...
public:
	...
	bool AddImage(string Path, string Tag, SDL_Rect Position, bool Interact, SDL_Rect SpriteSheet, int Frames, string Direction, SDL_Renderer * Renderer, bool CenterOrigin);
	...
	/// <param name="Renderer">SDL_Renderer to allow the sprite to be drawn.</param>
	/// <param name="CenterOrigin">bool to check if user wants to set the origin of the image to the center</param>
	bool AddImage(SDL_Texture * IMG, string Tag, SDL_Rect Position, bool Interact, SDL_Rect SpriteSheet, int Frames, string Direction, SDL_Renderer * Renderer, bool CenterOrigin);

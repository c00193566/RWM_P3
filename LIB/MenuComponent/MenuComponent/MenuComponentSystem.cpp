...
bool MenuSystem::AddImage(string Path, string Tag, SDL_Rect Position, bool Interact, SDL_Rect SpriteSheet, int Frames, string Direction, SDL_Renderer * Renderer, bool CenterOrigin)
{
	if (Images)
	{
...
bool MenuSystem::AddImage(SDL_Texture * IMG, string Tag, SDL_Rect Position, bool Interact, SDL_Rect SpriteSheet, int Frames, string Direction, SDL_Renderer * Renderer, bool CenterOrigin)
{
	if (Images)
	{
